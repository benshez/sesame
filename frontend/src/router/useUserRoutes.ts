...
export const useUserRoutes = () => {
  const GetRoutes = (): RouteRecordRaw[] => {
    return [
      ...
      {
        path: "/map/:tenantId/:userId/:eventId",
        name: "map",
        component: () =>
      ...
      },
      {
        ...
        meta: {
          ...
          isVisibleInMenu: async () => {
            const userStore = useUserStore();
            const isVisible = await userStore.UserHasRole("tenant.user.calendar.view");
            return isVisible;
          }
        },
      },        
