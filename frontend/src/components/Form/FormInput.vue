    ...
    <template v-slot:component>
      <div class="relative">
        <input v-if="!element.isReadonly" v-model="element.value" :id="element.id" :name="element.id"
          :type="element.type" :placeholder="element.placeholderText"
          :class="inputCssClass(element)"
        ...
        <span class="absolute right-3.5 top-1/2 -translate-y-1/2">
          ...
          <svg v-if="!element.isValid" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path fill-rule="evenodd" clip-rule="evenodd"
